import type { PersonhoodState } from "../../types/personhood";

type DisplayState = PersonhoodState | "idle" | "starting" | "awaiting" | "verifying";
...
function activeStep(state: DisplayState): number {
  switch (state) {
    case "idle":
    case "starting":
      return 0;
...
export function PersonhoodProgress({ state, failed }: Props) {
