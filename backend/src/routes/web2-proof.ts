      ...
      templates: [
        {
          ...
          zkpassSchemaId: process.env.ZKPASS_TWITTER_SCHEMA_ID || "43194186dd1f44a89f727ba64826c961",
        },
        {
          id: "discord-account",
          name: "Discord Account",
          description: "Prove you own a Discord account",
          zkpassSchemaId: process.env.ZKPASS_DISCORD_SCHEMA_ID || "84c3fd146b344733892ddb5c62572c37",
        },
        {
          id: "cex-balance",
          name: "CEX KYC Level",
          description: "Prove your KYC level on a centralized exchange",
          zkpassSchemaId: process.env.ZKPASS_CEX_SCHEMA_ID || "14e184e6ef3d49a0b4d6a6f8c84845cf",
        },
        {
          id: "linkedin-account",
          name: "LinkedIn Account",
          description: "Prove you own a LinkedIn account",
          zkpassSchemaId: process.env.ZKPASS_LINKEDIN_SCHEMA_ID || "205491152e184e27a09553c062e5ec9a",
        },
        {
          id: "reddit-account",
          name: "Reddit Account",
          description: "Prove you own a Reddit account",
          zkpassSchemaId: process.env.ZKPASS_REDDIT_SCHEMA_ID || "bc73d18fb0464e429110b578118cab04",
        },
      ],
    },
  });
